...
function BookingElement({
  ...
  const startTime = momentTimezone.tz(bookingData.bookingStart, "Asia/Taipei").format('h.mma')
  const endTime = momentTimezone.tz(bookingData.bookingEnd, "Asia/Taipei").format('h.mma')
