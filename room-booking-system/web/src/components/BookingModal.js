      ...
      {!!props.selectedBooking && (
        <div className="modal__boday">
          ...
          <p className="modal__paragraph">{`${momentTimezone
              .tz(props.selectedBooking['bookingStart'], 'Asia/Taipei')
            .format('h.mma')} to ${momentTimezone
              .tz(props.selectedBooking['bookingEnd'], 'Asia/Taipei')
              .format('h.mma')}`}
          ...
          <p className="modal__paragraph"><strong>活動主題  </strong>{props.selectedBooking['purpose']}</p>
